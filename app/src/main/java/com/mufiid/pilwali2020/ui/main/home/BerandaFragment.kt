...
import com.mufiid.pilwali2020.ui.customdialog.OpenDialogFragment
import com.mufiid.pilwali2020.ui.login.LoginActivity
import com.mufiid.pilwali2020.ui.monitoring.MonitoringActivity
import com.mufiid.pilwali2020.ui.pilwali.PilwaliActivity
import com.mufiid.pilwali2020.ui.tps.TpsActivity
...
class BerandaFragment : Fragment(), ITpsView, IConfigView, IPaslonView, View.OnClickListener {
    ...
    private fun createImageSlider(string: List<String?>?) {
        viewPager?.adapter = SliderAdapter(requireContext(), string)
